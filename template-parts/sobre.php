    ...
    <h2 class="title">
      <?php echo get_the_title(); ?>
		...
		<div class="description">
			...
			<p>
			A <a href="http://royalleeventos.com.br" target="_self"><strong>Royalle Eventos</strong></a>, <strong>barraquinhas em casa</strong> leva até você o dinamismo da gastronomia com alimentos preparados na hora, o que faz com que os alimentos sejam servidos quentinhos e saborosos. Os nossos colaboradores tem o prazer de mostrar o preparo dos lanchinhos com todo carinho. Gostamos de ressaltar nossas <strong>Mini Pizzas</strong> e nossos <strong>Mini X-Burger</strong>  pois não tem conservantes.
